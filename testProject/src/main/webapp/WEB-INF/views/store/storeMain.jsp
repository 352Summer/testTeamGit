...
<html>
	...
	<div id="page">
		...
		<%@ include file="/views/final/header.jsp" %>
		
		<div class="breadcrumbs">
			<div class="container">
				<div class="row">
					<div class="col">
						<p class="bread"><span><a href="<%= request.getContextPath() %>/views/final/summer.jsp">Home</a></span> / <span>Store Main</span></p>
					</div>
				</div>
			</div>
		</div>
		...
		<%@ include file="/views/final/footer.jsp" %>
