	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(<%= request.getContextPath() %>/resources/images/img_bg_1.jpg);">
			   	...
			   	<li style="background-image: url(<%= request.getContextPath() %>/resources/images/img_bg_2.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-sm-6 offset-sm-3 text-center slider-text">
			   	...
			   	<li style="background-image: url(<%= request.getContextPath() %>/resources/images/img_bg_3.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-sm-6 offset-sm-3 text-center slider-text">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="#" class="featured-img" style="background-image: url(<%= request.getContextPath() %>/resources/images/men.jpg);"></a>
							<div class="desc">
					...
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="#" class="featured-img" style="background-image: url(<%= request.getContextPath() %>/resources/images/women.jpg);"></a>
							<div class="desc">
